...
st.markdown("""
<style>
    /* DeepSeek-inspired color scheme */
    :root {
        /* Core colors */
        --primary-dark: #0A192F;      /* Dark navy background */
        --primary-medium: #112240;   /* Slightly lighter navy for elements */
        --primary-light: #233554;    /* Light navy for accents */
        --text-color: #CCD6F6;       /* Light gray text for contrast */
    ...
    .stButton>button:hover {
        background-color: #52D1C2; /* Slightly darker teal */
